...
**Repository:** [github.com/FARHANMOHAMMED-R/farhan_new](https://github.com/FARHANMOHAMMED-R/farhan_new)  
...
```bash
git clone git@github.com:FARHANMOHAMMED-R/farhan_new.git
cd farhan_new
open index.html
```
